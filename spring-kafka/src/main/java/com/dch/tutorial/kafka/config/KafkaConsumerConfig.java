...
/**
 * Class that configure a ConsumerFactory and a KafkaListenerContainerFactory.
 * Once these beans are available in spring bean factory, POJO based consumers
 * can be configured using @KafkaListener annotation.
 * <p>
 * {@link EnableKafka} annotation is required on the configuration class
